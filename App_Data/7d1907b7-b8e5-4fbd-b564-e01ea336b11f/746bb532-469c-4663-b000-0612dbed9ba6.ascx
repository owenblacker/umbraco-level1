...
<link rel="stylesheet" href="<%= MainPath %>css/style.css?version=1.1.7WIP" type="text/css" media="screen" />
...
<script type="text/javascript" src="<%= MainPath %>scripts/umbracoforms.js?version=1.1.7WIP"></script>
